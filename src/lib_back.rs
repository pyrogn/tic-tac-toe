...
use pyo3::prelude::*;
// credits of tic tac toe with minimax in Rust
// to https://github.com/arisnacg/rust-tictactoe
...
// TODO: doesn't need two chars and two conditions (maximizing)
fn minimax(
...
// #[pyfunction]
// pyfunction should receive tuple[mark, list[list[str]]] I think for simplicity and return
// a best move
fn ai_best_move(
    board: &mut Vec<Vec<char>>,
    ai_char: char,
